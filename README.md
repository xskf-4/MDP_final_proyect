...
El programa utiliza códigos ANSI ESCAPE para establecer colores en la terminal. Utilizar el programa en una terminal que no admita true-color resultará en comportamiento no deseable al menos visualmente (Se está trabajando en ello).
### Uso
